...
const EmailVerify = ({ user }) => {
  ...
  return (
    <Container className="flex items-center border border-[color:var(--accents-2)] text-sm mb-4 px-3 py-[7px] rounded-[5px] border-solid">
      <Container flex={1}>
        <p>
          <strong>Note:</strong> <span>Your email</span> (
          <span className="text-[color:var(--link)]">{user.email}</span>) is
          unverified.
        </p>
      </Container>
...
const Auth = () => {
  ...
  return (
    <section className="border border-[color:var(--accents-2)] mb-4 p-6 rounded-[5px] border-solid">
  ...
  return (
    <section className="border border-[color:var(--accents-2)] mb-4 p-6 rounded-[5px] border-solid">
      ...
      <form onSubmit={onSubmit}>
        ...
        <Spacer size={0.5} axis="vertical" />
        <span className="block text-xs font-medium text-[color:var(--secondary)] uppercase max-w-full mb-2">
          Your Avatar
        </span>
        <div className="relative w-24 h-24 transition-[ease] duration-[0.2s] ease-[opacity] hover:opacity-50">
          ...
          <input
            ...
            className="absolute w-full h-full opacity-0 z-[1] cursor-pointer inset-0"
          />
        </div>
        <Spacer size={0.5} axis="vertical" />
        <Button
